...
#define	_BOARD_NAME_	"MAKEmicro32"
...
/*  You must manually wire LED to pin in order to use        */
/*  Breadboard side of pin 5 you connect LED                 */
/*  Connect one side of LED to pin 5 and one side to ground  */

#define	PIN_LED1  5 // 5 RB4  SOSCI/RPB4/RB4
...
/* One button Bootload/Program for this board */

#define	PIN_BTN1  6 // 6 RB3  AN5/C1INA/C2INC/RTCC/RPB3/SCL2/PMWR/RB3
...
#define PIN_OC1		 9      // B15   RPB15R  = 5  
#define	PIN_OC2		15      // B8    RPB8R   = 5
#define	PIN_OC3		14      // B9    RPB9R   = 5
#define	PIN_OC4		 4      // B2    RPB2R   = 5
#define	PIN_OC5		11      // B13   RPB13R  = 6

#define PIN_IC1		11      // RB13 IC1R = RPB13 = 3
#define PIN_IC2		 2      // B0   IC2R = RPB0  = 2
#define PIN_IC3		15      // B8   IC3R = RPB8  = 4
#define PIN_IC4		 5      // B3   IC4R = RPB3  = 1
#define	PIN_IC5		 4      // RB2  IC5R = RPB2  = 4

#define	PIN_TCK1	 7      // A4, non PPS
#define	PIN_TCK2	 5      // B3   T2CKR = RPB3  = 1
#define	PIN_TCK3	 3      // B1   T3CKR = RPB1  = 2
#define	PIN_TCK4	11      // B13  T4CKR = RPB13 = 3
#define	PIN_TCK5	14      // B9   T5CKR = RPB9  = 4

/* ------------------------------------------------------------ */
/*					Interrupt Pin Declarations					*/
/* ------------------------------------------------------------ */

#define	PIN_INT0	16      // RB7 non-PPS
#define	PIN_INT1	14      // B9  INT1R = RPB9 = 4
#define PIN_INT2	 4      // B2  INT2R = RPB2 = 4
#define	PIN_INT3	15      // B8  INT3R = RPB8 = 4
...
*/
const static uint8_t SS   =  0;		// RA0  CS1     PGED3/VREF+/CVREF+/AN0/C3INC/RPA0/CTED1/PMD7/RA0 
const static uint8_t MISO =  1;		// RA1  SDI1    SDI1R = RPA1 = 0 
const static uint8_t MOSI =	 7;		// RA4  SDO1    RPA4R = SDO1 = 3    
const static uint8_t SCK  = 10;		// RB14 SCK1    CVREF/AN10/C3INB/RPB14/VBUSON/SCK1/CTED5/RB14

/* The Digilent DSPI library uses these ports.
*/
#define	PIN_DSPI0_SS	0           // 0    RA0  PGED3/VREF+/CVREF+/AN0/C3INC/RPA0/CTED1/PMD7/RA0          
#define	PIN_DSPI1_SS	5          //  5	RB3  AN5/C1INA/C2INC/RTCC/RPB3/SCL2/PMWR/RB3
/* ------------------------------------------------------------ */
/*					Analog Pins									*/
/* ------------------------------------------------------------ */
...
** pin number.
*/
#define A0		 0  // RA0     PGED3/VREF+/CVREF+/AN0/C3INC/RPA0/CTED1/PMD7/RA0
#define A1		 1  // RA1     PGEC3/VREF-/CVREF-/AN1/RPA1/CTED2/PMD6/RA1 
#define A2		 2  // RB0     PGED1/AN2/C1IND/C2INB/C3IND/RPB0/PMD0/RB0
#define A3		 3  // RB1     PGEC1/AN3/C1INC/C2INA/RPB1/CTED12/PMD1/RB1  
#define A4		 4  // RB2     AN4/C1INB/C2IND/RPB2/SDA2/CTED13/PMD2/RB2 
#define A5		 5  // RB3     AN5/C1INA/C2INC/RTCC/RPB3/SCL2/PMWR/RB3
#define A6		 9  // RB15    AN9/C3INA/RPB15/SCK2/CTED6/PMCS1/RB15
#define	A7		10  // RB14    CVREF/AN10/C3INB/RPB14/VBUSON/SCK1/CTED5/RB14
#define	A8		11  // RB13    AN11/RPB13/CTPLS/PMRD/RB13
...
** pins.
*/
#define	PIN_CN0	     0  //  0       RA0     PGED3/VREF+/CVREF+/AN0/C3INC/RPA0/CTED1/PMD7/RA0
#define	PIN_CN1      1  //  1       RA1     PGEC3/VREF-/CVREF-/AN1/RPA1/CTED2/PMD6/RA1  
#define	PIN_CN2      2  //  2       RB0     PGED1/AN2/C1IND/C2INB/C3IND/RPB0/PMD0/RB0  
#define	PIN_CN3      3  //  3       RB1     PGEC1/AN3/C1INC/C2INA/RPB1/CTED12/PMD1/RB1  
#define	PIN_CN4      4  //  4       RB2     AN4/C1INB/C2IND/RPB2/SDA2/CTED13/PMD2/RB2  
#define	PIN_CN5      5  //  5       RB3     AN5/C1INA/C2INC/RTCC/RPB3/SCL2/PMWR/RB3
#define	PIN_CN6      6  //  6       RB4     SOSCI/RPB4/RB4 
#define	PIN_CN7      7  //  7       RA4     SOSCO/RPA4/T1CK/CTED9/PMA1/RA4 
#define	PIN_CN8      8  //  8       RB5     TMS/RPB5/USBID/RB5
#define	PIN_CN9      9  //  9       RB15    AN9/C3INA/RPB15/SCK2/CTED6/PMCS1/RB15
#define	PIN_CN10    10  // 10       RB14    CVREF/AN10/C3INB/RPB14/VBUSON/SCK1/CTED5/RB14
#define	PIN_CN11    11  // 11       RB13    AN11/RPB13/CTPLS/PMRD/RB13
#define	PIN_CN12    12  // 12       RB11    PGEC2/RPB11/D-/RB11
#define	PIN_CN13    13  // 13       RB10    PGED2/RPB10/D+/CTED11/RB10
#define	PIN_CN14    14  // 14       RB9     TDO/RPB9/SDA1/CTED4/PMD3/RB9
#define	PIN_CN15    15  // 15       RB8     TCK/RPB8/SCL1/CTED10/PMD4/RB8
#define	PIN_CN16    16  // 16       RB7     TDI/RPB7/CTED3/PMD5/INT0/RB7   
...
#define       _SER0_TX_PIN         5                // RB3  AN5/C1INA/C2INC/RTCC/RPB3/SCL2/PMWR/RB3     
#define       _SER0_RX_IN          PPS_IN_U1RX      // U1RXR = RPB13 = 3
#define       _SER0_RX_PIN         11               // RB13 AN11/RPB13/CTPLS/PMRD/RB13  
...
#define       _SER1_TX_PIN         10               // RB14 CVREF/AN10/C3INB/RPB14/VBUSON/SCK1/CTED5/RB14
#define       _SER1_RX_IN          PPS_IN_U2RX      // U2RXR = RPA1 = 0
#define       _SER1_RX_PIN         1               // RA1  PGEC3/VREF-/CVREF-/AN1/RPA1/CTED2/PMD6/RA1 
...
#define _DSPI0_MISO_PIN		1 				// RA1  SDI1    SDI1R = RPA1 = 0 
#define _DSPI0_MOSI_OUT		PPS_OUT_SDO1
#define _DSPI0_MOSI_PIN		7				// RA4  SDO1    RPA4R = SDO1 = 3
...
#define _DSPI1_MISO_PIN		4				// RB2  SDI2    SDI2R = RPB2 = 4
#define _DSPI1_MOSI_OUT		PPS_OUT_SDO2
#define _DSPI1_MOSI_PIN		15				// RB8  SDO2    RPB8R = SDO2 = 4 
